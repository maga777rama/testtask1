...
import { CardList } from "../shared/components/cardList.tsx";
...
export const Route = createFileRoute("/")({
    component: Index,
    // тут можно было вместо "Index" указать ()=> <Navigate to={'./cards'}/>
    // чтобы при открытии начальной страницы "/" происходил редирект на страницу "/cards"
    // но я посчитал это излишеством
});
